...
function ArrivalPage() {
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto", textAlign: "left", fontFamily: "sans-serif" }}>
      ...
      <p style={{ fontSize: "1rem", color: "#777", marginBottom: "32px", fontStyle: "italic" }}>Please follow these guidelines to ensure proper use of all marae facilities. Click on any section to expand.</p>

      {/* Airconditioning */}
      <CollapsibleSection id="aircon" title="Airconditioning" color="#1976d2">
      ...
      {/* Bakers Oven */}
      <CollapsibleSection id="bakersOven" title="Bakers Oven" color="#e65100">
      ...
      {/* Bratt Pan */}
      <CollapsibleSection id="brattPan" title="Bratt Pan" color="#2e7d32">
        <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
      ...
      {/* Chairs */}
      <CollapsibleSection id="chairs" title="Chairs" color="#c2185b">
        <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
      ...
      {/* Chiller */}
      <CollapsibleSection id="chiller" title="Chiller" color="#00695c">
        <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
      ...
      <div style={{ marginBottom: "28px" }}>
        <h2 style={{ color: "#2c3e50", marginTop: 0, marginBottom: "16px", fontSize: "1.3rem", borderBottom: "2px solid #d4af37", paddingBottom: "12px" }}>Cleaning Instructions</h2>

        <CollapsibleSection id="cleanDining" title="Clean – Final Dining Hall" color="#d84315">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="cleanKitchen" title="Clean – Final Kitchen" color="#1b5e20">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="cleanToilets" title="Clean – Final Toilets" color="#004d40">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="cleanWharenui" title="Clean – Final Wharenui" color="#1565c0">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="cleanEquipment" title="Cleaning Equipment" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
      ...
      {/* Equipment & Appliances Section */}
      <div style={{ marginBottom: "28px" }}>
        <h2 style={{ color: "#2c3e50", marginTop: 0, marginBottom: "16px", fontSize: "1.3rem", borderBottom: "2px solid #d4af37", paddingBottom: "12px" }}>Equipment & Appliances</h2>

        <CollapsibleSection id="combiOvens" title="Combi Ovens" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="deepFryer" title="Deep Fryer" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
            <li>It takes about 20 Litres of oil to use this, Fryer. To start do the same instructions as for the Bakers Oven.</li>
          </ul>
        </CollapsibleSection>

        <CollapsibleSection id="defibrillator" title="Defibrillator" color="#d32f2f">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="dishWasher" title="Dish Washer" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="dishes" title="Dishes" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="freezers" title="Freezers" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="fridges" title="Fridges" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="gas" title="Gas" color="#ff6f00">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="grillTops" title="Grill Tops" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="hangiCookers" title="Hangi Cookers" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
            <li>Hangi Cookers should have a connection directly to the wall gas outlet.</li>
          </ul>
        </CollapsibleSection>

        <CollapsibleSection id="hotBoxes" title="Hot Boxes" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="hotWater" title="Hot Water" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="microwave" title="Microwave" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
      ...
      {/* Facilities & General Section */}
      <div style={{ marginBottom: "28px" }}>
        <h2 style={{ color: "#2c3e50", marginTop: 0, marginBottom: "16px", fontSize: "1.3rem", borderBottom: "2px solid #d4af37", paddingBottom: "12px" }}>Facilities & General Information</h2>

        <CollapsibleSection id="evacuation" title="Evacuation Point" color="#d32f2f">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
            <li>The Evacuation point is located in the front car park by the main road.</li>
          </ul>
        </CollapsibleSection>

        <CollapsibleSection id="firstAid" title="First Aid" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
            <li>The 1<sup>st</sup> Aid kit is located at the shelf next to the Urn.</li>
          </ul>
        </CollapsibleSection>

        <CollapsibleSection id="flag" title="Flag / Kara" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
            <li>The Flag / Kara will stay up during the whole duration of the hui/tangi/wananga.</li>
          </ul>
        </CollapsibleSection>

        <CollapsibleSection id="floors" title="Floors" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="linen" title="Linen" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="loadingDock" title="Loading Dock" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="mattressRoom" title="Mattress Room" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="lights" title="Lights" color="#2c3e50">
          <div>
        ...
        <CollapsibleSection id="parking" title="Parking" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="pigBins" title="Pig Bins" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="recyclingBins" title="Recycling Bins" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
            <li>There is a limited amount of recycling bins. Please fill these bins and then place any extra in rubbish bags.</li>
          </ul>
        </CollapsibleSection>

        <CollapsibleSection id="rubbish" title="Rubbish" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="showers" title="Showers" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="smoking" title="Smoking" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
            <li>Smoking is only permitted by the back Green toilets to the back of the loading dock.</li>
          </ul>
        </CollapsibleSection>

        <CollapsibleSection id="tables" title="Tables" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="toilets" title="Toilets" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="trolleys" title="Trolleys" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="vacuum" title="Vacuum" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
        ...
        <CollapsibleSection id="wifi" title="WiFi" color="#2c3e50">
          <ul style={{ lineHeight: 1.8, color: "#555", margin: 0, paddingLeft: "20px" }}>
